...
import com.example.project_2.databinding.BatteryPageBinding;

public class BatteryPage extends AppCompatActivity {
    BatteryPageBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = BatteryPageBinding.inflate(getLayoutInflater());
    ...
    public static Intent batteryPageIntentFactory(Context context){
        return new Intent(context, BatteryPage.class);
    }
}