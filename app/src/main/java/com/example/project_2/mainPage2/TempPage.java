...
import com.example.project_2.databinding.TempPageBinding;

public class TempPage extends AppCompatActivity {
    TempPageBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = TempPageBinding.inflate(getLayoutInflater());
    ...
    public static Intent tempPageIntentFactory(Context context){
        return new Intent(context, TempPage.class);
    }
}